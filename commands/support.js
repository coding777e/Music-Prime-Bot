...
module.exports = {
  ...
  run: async (client, interaction) => {
    try {
      ...
      const supportServerLink = "https://discord.gg/CqfsxyGf7s";
        const embed = new EmbedBuilder()
            ...
            .setImage('https://p4.wallpaperbetter.com/wallpaper/663/467/591/anime-sunset-landscape-clouds-sky-wallpaper-preview.jpg')
            .setTimestamp();
